...
function MyDashboard() {
  ...
  const fetchChartsFromSAC = async () => {
    try {
      ...
      // **כאן תכניסי את הקוד שלך לשליפה מהשרת**
      // לדוגמה:
      /*
      const response = await fetch('/api/sac/charts', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${yourToken}` // החלף עם הטוקן שלך
        }
      });
      ...
      */
      ...
      // דמה זמנית - החלף עם הקוד האמיתי שלך
      const chartsData = [
        {
          id: 'chart1',
          name: 'Sales Performance',
          type: 'bar',
          description: 'תרשים ביצועי מכירות',
          url: 'https://piba-qa.il30.hcs.cloud.sap/sap/fpa/ui/app.html#/story2&/s2/BDAE63DB7638245C442E8573ECE1FC62/?mode=present'
        },
        {
          id: 'chart2',
          name: 'Market Share',
          type: 'pie',
          description: 'חלוקת נתח שוק',
          url: 'https://piba-qa.il30.hcs.cloud.sap/sap/fpa/ui/app.html#/story2&/s2/F3696576161D527ECEC5C32A4DF859B0/?mode=present'
        },
        {
          id: 'chart3',
          name: 'Revenue Trend',
          type: 'line',
          description: 'מגמת הכנסות',
